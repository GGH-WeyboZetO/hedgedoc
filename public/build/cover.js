...
/*!*********************************!*\
  !*** ./locales/_supported.json ***!
  \*********************************/
/*! exports provided: en, zh-CN, zh-TW, fr, de, ja, es, ca, el, pt, it, tr, ru, nl, hr, pl, uk, hi, sv, eo, da, ko, id, sr, vi, ar, cs, sk, ml, bg, fa, gl, he, hu, oc, pt-br, lt, ro, sl, eu, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"en\":\"English\",\"zh-CN\":\"简体中文\",\"zh-TW\":\"繁體中文\",\"fr\":\"Français\",\"de\":\"Deutsch\",\"ja\":\"日本語\",\"es\":\"Español\",\"ca\":\"Català\",\"el\":\"Ελληνικά\",\"pt\":\"Português\",\"it\":\"Italiano\",\"tr\":\"Türkçe\",\"ru\":\"Русский\",\"nl\":\"Nederlands\",\"hr\":\"Hrvatski\",\"pl\":\"Polski\",\"uk\":\"Українська\",\"hi\":\"हिन्दी\",\"sv\":\"Svenska\",\"eo\":\"Esperanto\",\"da\":\"Dansk\",\"ko\":\"한국어\",\"id\":\"Bahasa Indonesia\",\"sr\":\"Cрпски\",\"vi\":\"Tiếng Việt\",\"ar\":\"العربية\",\"cs\":\"Česky\",\"sk\":\"Slovensky\",\"ml\":\"മലയാളം\",\"bg\":\"български език\",\"fa\":\"فارسی\",\"gl\":\"Galego\",\"he\":\"עברית\",\"hu\":\"Magyar\",\"oc\":\"Occitan\",\"pt-br\":\"Português do Brasil\",\"lt\":\"Lietuvių kalba\",\"ro\":\"Română\",\"sl\":\"Slovenski jezik\",\"eu\":\"Euskara\"}");
...
var _login = __webpack_require__(/*! ./lib/common/login */ "./public/js/lib/common/login.js");

var _history = __webpack_require__(/*! ./history */ "./public/js/history.js");

var _fileSaver = __webpack_require__(/*! file-saver */ "./node_modules/file-saver/dist/FileSaver.min.js");

var _list = __webpack_require__(/*! list.js */ "./node_modules/list.js/src/index.js");

var _list2 = _interopRequireDefault(_list);

var _string = __webpack_require__(/*! string */ "./node_modules/string/lib/string.js");

var _string2 = _interopRequireDefault(_string);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

__webpack_require__(/*! ./locale */ "./public/js/locale.js"); /* eslint-env browser, jquery */
/* global moment, serverurl */

__webpack_require__(/*! ../css/cover.css */ "./public/css/cover.css");
__webpack_require__(/*! ../css/site.css */ "./public/css/site.css");

__webpack_require__(/*! ./fix-aria-hidden-for-modals */ "./public/js/fix-aria-hidden-for-modals.js");
...
var historyList = new _list2.default('history', options);

window.migrateHistoryFromTempCallback = pageInit;
(0, _login.setloginStateChangeEvent)(pageInit);

pageInit();

function pageInit() {
  (0, _login.checkIfAuth)(function (data) {
    $('.ui-signin').hide();
    $('.ui-or').hide();
    $('.ui-welcome').show();
    if (data.photo) $('.ui-avatar').prop('src', data.photo).show();else $('.ui-avatar').prop('src', '').hide();
    $('.ui-name').html(data.name);
    $('.ui-signout').show();
    $('.ui-history').click();
    (0, _history.parseServerToHistory)(historyList, parseHistoryCallback);
  }, function () {
    $('.ui-signin').show();
    $('.ui-or').show();
    $('.ui-welcome').hide();
    ...
    $('.ui-name').html('');
    $('.ui-signout').hide();
    (0, _history.parseStorageToHistory)(historyList, parseHistoryCallback);
  });
}
...
function checkHistoryList() {
  if ($('#history-list').children().length > 0) {
    ...
    (0, _history.getStorageHistory)(function (data) {
      if (data && data.length > 0 && (0, _login.getLoginState)() && historyList.items.length === 0) {
...
function historyPinClick(e) {
  ...
  (0, _login.checkIfAuth)(function () {
    (0, _history.postHistoryToServer)(id, {
      pinned: pinned
    }, function (err, result) {
      if (!err) {
        if (pinned) {
    ...
    (0, _history.getHistory)(function (notehistory) {
      ...
      (0, _history.saveHistory)(notehistory);
      if (pinned) {
        $this.addClass('active');
      } else {
        $this.removeClass('active');
...
function deleteHistory() {
  (0, _login.checkIfAuth)(function () {
    (0, _history.deleteServerHistory)(deleteId, function (err, result) {
      if (!err) {
        if (clearHistory) {
          historyList.clear();
          checkHistoryList();
    ...
    if (clearHistory) {
      ...
      if (!deleteId) return;
      (0, _history.getHistory)(function (notehistory) {
        var newnotehistory = (0, _history.removeHistory)(deleteId, notehistory);
        (0, _history.saveHistory)(newnotehistory);
        historyList.remove('id', deleteId);
        checkHistoryList();
        deleteId = null;
      });
...
$('.ui-delete-history-modal-confirm').click(function () {
  deleteHistory();
});

$('.ui-import-from-browser').click(function () {
  (0, _history.saveStorageHistoryToServer)(function () {
    (0, _history.parseStorageToHistory)(historyList, parseHistoryCallback);
  });
});

$('.ui-save-history').click(function () {
  (0, _history.getHistory)(function (data) {
    var history = (0, _stringify2.default)(data);
    var blob = new Blob([history], {
      type: 'application/json;charset=utf-8'
    });
    (0, _fileSaver.saveAs)(blob, 'hedgedoc_history_' + moment().format('YYYYMMDDHHmmss'), true);
  });
});
...
$('.ui-open-history').bind('change', function (e) {
  ...
  reader.onload = function () {
    ...
    (0, _history.getHistory)(function (data) {
      ...
      mergedata = (0, _history.clearDuplicatedHistory)(mergedata);
      (0, _history.saveHistory)(mergedata);
      (0, _history.parseHistory)(historyList, parseHistoryCallback);
    });
...
$('.ui-refresh-history').click(function () {
  ...
  (0, _login.resetCheckAuth)();
  historyList.clear();
  (0, _history.parseHistory)(historyList, function (list, notehistory) {
...
$('.ui-delete-user-modal-cancel').click(function () {
  $('.ui-delete-user').parent().removeClass('active');
});

$('.ui-logout').click(function () {
  (0, _login.clearLoginState)();
...
function buildTagsFilter(tags) {
  for (var i = 0; i < tags.length; i++) {
    tags[i] = {
      id: i,
      text: (0, _string2.default)(tags[i]).unescapeHTML().s
    };
  }
  filtertags = tags;
}
  ...
  if (tags.length > 0) {
    historyList.filter(function (item) {
      ...
      for (var _i = 0; _i < tags.length; _i++) {
        if (values.tags.includes(tags[_i])) {
          found = true;
          break;
        }
      }
...
$('.signin-modal').on('shown.bs.modal', function () {
  var fieldLDAP = $('input[name=username]');
  var fieldEmail = $('input[name=email]');
  var fieldOpenID = $('input[name=openid_identifier]');
...
exports.saveStorageHistoryToServer = saveStorageHistoryToServer;
exports.clearDuplicatedHistory = clearDuplicatedHistory;
...
exports.parseServerToHistory = parseServerToHistory;
exports.parseStorageToHistory = parseStorageToHistory;
exports.postHistoryToServer = postHistoryToServer;
exports.deleteServerHistory = deleteServerHistory;
...
var _wurl = __webpack_require__(/*! wurl */ "./node_modules/wurl/wurl.js");

var _wurl2 = _interopRequireDefault(_wurl);

var _utils = __webpack_require__(/*! ./utils */ "./public/js/utils.js");

var _login = __webpack_require__(/*! ./lib/common/login */ "./public/js/lib/common/login.js");

var _config = __webpack_require__(/*! ./lib/config */ "./public/js/lib/config/index.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.migrateHistoryFromTempCallback = null; /* eslint-env browser, jquery */
...
function migrateHistoryFromTemp() {
  if ((0, _wurl2.default)('#tempid')) {
    $.get(serverurl + '/temp', {
      tempid: (0, _wurl2.default)('#tempid')
    }).done(function (data) {
      if (data && data.temp) {
...
function saveHistoryToStorage(notehistory) {
  _store2.default.set('notehistory', (0, _stringify2.default)(notehistory));
}

function saveHistoryToServer(notehistory) {
  $.post(serverurl + '/history', {
    history: (0, _stringify2.default)(notehistory)
  });
}

function saveStorageHistoryToServer(callback) {
  var data = _store2.default.get('notehistory');
  if (data) {
    $.post(serverurl + '/history', {
      history: data
    }).done(function (data) {
...
function renderHistory(title, tags) {
  // console.debug(tags);
  var id = _config.urlpath ? location.pathname.slice(_config.urlpath.length + 1, location.pathname.length).split('/')[1] : location.pathname.split('/')[1];
  return {
    id: id,
    text: title,
    time: moment().valueOf(),
...
function getServerHistory(callback) {
  $.get(serverurl + '/history').done(function (data) {
    if (data.history) {
...
function parseToHistory(list, notehistory, callback) {
  if (!callback) return;else if (!list || !notehistory) callback(list, notehistory);else if (notehistory && notehistory.length > 0) {
    for (var i = 0; i < notehistory.length; i++) {
      // migrate LZString encoded id to base64url encoded id
      try {
        var id = _lzString2.default.decompressFromBase64(notehistory[i].id);
        if (id && (0, _utils.checkNoteIdValid)(id)) {
          notehistory[i].id = (0, _utils.encodeNoteId)(id);
        }
      } catch (err) {
        console.error(err);
      }
      ...
      // prevent XSS
      notehistory[i].text = (0, _string2.default)(notehistory[i].text).escapeHTML().s;
      notehistory[i].tags = notehistory[i].tags && notehistory[i].tags.length > 0 ? (0, _string2.default)(notehistory[i].tags).escapeHTML().s.split(',') : [];
      // add to list
...
function postHistoryToServer(noteId, data, callback) {
  $.post(serverurl + '/history/' + noteId, data).done(function (result) {
...
exports.setloginStateChangeEvent = setloginStateChangeEvent;
exports.resetCheckAuth = resetCheckAuth;
exports.setLoginState = setLoginState;
exports.checkLoginStateChanged = checkLoginStateChanged;
exports.getLoginState = getLoginState;
exports.getUserId = getUserId;
exports.clearLoginState = clearLoginState;
exports.checkIfAuth = checkIfAuth;

var _config = __webpack_require__(/*! ../config */ "./public/js/lib/config/index.js");

var checkAuth = false; /* eslint-env browser, jquery */
/* global Cookies */
...
function checkIfAuth(yesCallback, noCallback) {
  ...
  if (!checkAuth || typeof cookieLoginState === 'undefined') {
    $.get(_config.serverurl + '/me').done(function (data) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! js-cookie */ "./node_modules/js-cookie/dist/js.cookie.js"), __webpack_require__(/*! jquery */ "jquery")))
...
var DROPBOX_APP_KEY = exports.DROPBOX_APP_KEY = window.DROPBOX_APP_KEY || '';

var domain = exports.domain = window.domain || ''; // domain name
var urlpath = exports.urlpath = window.urlpath || ''; // sub url path, like: www.example.com/<urlpath>
var debug = exports.debug = window.debug || false;

var port = exports.port = window.location.port;
var serverurl = exports.serverurl = window.location.protocol + '//' + (domain || window.location.hostname) + (port ? ':' + port : '') + (urlpath ? '/' + urlpath : '');
window.serverurl = serverurl;
var noteid = exports.noteid = decodeURIComponent(urlpath ? window.location.pathname.slice(urlpath.length + 1, window.location.pathname.length).split('/')[1] : window.location.pathname.split('/')[1]);
var noteurl = exports.noteurl = serverurl + '/' + noteid;

var version = exports.version = window.version;
...
/* global Cookies */
var supportedLanguages = __webpack_require__(/*! ../../locales/_supported.json */ "./locales/_supported.json");

function detectLang() {
  if (Cookies.get('locale')) {
    var _lang = Cookies.get('locale');
    if (_lang === 'zh') {
      _lang = 'zh-TW';
    }
    return _lang;
  ...
  var supportedLanguagesList = (0, _keys2.default)(supportedLanguages);
...
var lang = detectLang();
var localeSelector = $('.ui-locale');
(0, _entries2.default)(supportedLanguages).forEach(function (_ref) {
...
exports.checkNoteIdValid = checkNoteIdValid;
exports.encodeNoteId = encodeNoteId;
exports.decodeNoteId = decodeNoteId;

var _base64url = __webpack_require__(/*! base64url */ "./node_modules/base64url/index.js");
...
function encodeNoteId(id) {
  ...
  var hexStr = Buffer.from(str, 'hex');
  return _base64url2.default.encode(hexStr);
}

function decodeNoteId(encodedId) {
  // decode from url-safe base64
  var id = _base64url2.default.toBuffer(encodedId).toString('hex');
...
/***/ 1:
/*!*************************************************!*\
  !*** multi babel-polyfill ./public/js/cover.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! /home/ggh/Bureau/LogLibre/hedgedoc/public/js/cover.js */"./public/js/cover.js");
